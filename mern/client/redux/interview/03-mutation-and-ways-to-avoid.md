...
> **ফাইলের নাম নিয়ে ছোট্ট সাজেশন:** তুমি যেই নাম দিয়েছো (`mutation-and-ways-to-avoid.md`) সেটাও ঠিক আছে, তবে চাইলে **`js-mutation-and-immer.md`** বা **`avoiding-mutation-in-redux.md`** — এই নামগুলোও ব্যবহার করতে পারো, যেহেতু নোটের শেষ অংশে Redux আর Immer নিয়েও কথা হয়েছে। আপাতত তোমার দেওয়া নামেই ফাইলটা রাখা হলো।
